  ...
  return (
    <>
      <div className="relative">
        ...
        <EventTimeLine timeLineData={timeLineData["dl-sprint"]} />

        <EventPrize prizeData={prizeMoney["dl-sprint"]} />

        <EventFaq faqData={faqData["dl-sprint"]} />

        <EventResources resources={resourcesData["dl-sprint"]} />
