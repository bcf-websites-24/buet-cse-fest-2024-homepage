  ...
  return (
    <>
      <div className="relative">
        ...
        <EventTimeLine timeLineData={timeLineData["hackathon"]} />

        <EventPrize prizeData={prizeMoney["hackathon"]} />

        <EventFaq faqData={faqData["hackathon"]} />

        <EventResources resources={resourcesData["hackathon"]} />
